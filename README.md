...
[**evolveapp.cc**](https://evolveapp.cc) · ✉️ evolveappcc@proton.me
...
5. Open Evolve from its new home-screen icon.

### Android
1. Open **evolveapp.cc** in **Chrome**.
2. If an **Install** banner appears, tap it — you're done.
3. Otherwise tap the **⋮** menu (top-right) → **Install app** / **Add to Home screen**.
4. Confirm, then open Evolve from its home-screen icon.
